...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.kgisl.studentspringboot.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.kgisl.studentspringboot.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.kgisl.studentspringboot.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.kgisl.studentspringboot.controller.*.*(..))", 
        throwing="excep")
